...
describe("Integration: Artists Endpoints", () => {
  ...
  it("getArtist can return information", async () => {
    ...
    expect(fetchSpy.request(0).input).toBe(
      `https://api.spotify.com/v1/artists/${valid.id}`,
    );
  ...
  it("getArtists can return multiple items", async () => {
    ...
    expect(fetchSpy.request(0).input).toBe(
      `https://api.spotify.com/v1/artists?ids=${valid.id}%2C${valid.id}`,
    );
  ...
  it("getArtistAlbums can return information", async () => {
    ...
    expect(fetchSpy.request(0).input).toBe(
      `https://api.spotify.com/v1/artists/${valid.id}/albums`,
    );
  ...
  it("getArtistTopTracks can return information", async () => {
    ...
    expect(fetchSpy.request(0).input).toBe(
      `https://api.spotify.com/v1/artists/${valid.id}/top-tracks?market=GB`,
    );
  ...
  it("getArtistRelatedArtists can return information", async () => {
    ...
    expect(fetchSpy.request(0).input).toBe(
      `https://api.spotify.com/v1/artists/${valid.id}/related-artists`,
    );
