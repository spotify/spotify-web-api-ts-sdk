export function validAudiobookChapterResponse() {
  return {
    restrictions: {
      reason: "payment_required",
    },
    id: "1T07H2V5GwrpPNAH6032ES",
    description: "",
    chapter_number: 0,
    duration_ms: 13000,
    explicit: false,
    images: [
      {
        height: 640,
        url: "https://i.scdn.co/image/ab676663000022a8f0722f9b6390ed3420e6f0a0",
        width: 640,
      },
      {
        height: 300,
        url: "https://i.scdn.co/image/ab6766630000db5bf0722f9b6390ed3420e6f0a0",
        width: 300,
      },
      {
        height: 64,
        url: "https://i.scdn.co/image/ab6766630000703bf0722f9b6390ed3420e6f0a0",
        width: 64,
      },
    ],
    languages: [""],
    ...
    audiobook: {
      ...
      languages: ["English"],
      media_type: "audio",
      name: "Girl, Alone (An Ella Dark FBI Suspense Thriller—Book 1): 01",
      narrators: [
        {
          name: "Abigail Reno",
        },
      ...
      total_chapters: null,
      type: "audiobook",
      uri: "spotify:show:19Xw49IjNbOCCoebfy3qA9",
    },
    type: "chapter",
    uri: "spotify:episode:1T07H2V5GwrpPNAH6032ES",
    external_urls: {
      spotify: "https://open.spotify.com/episode/1T07H2V5GwrpPNAH6032ES",
    },
    href: "https://api.spotify.com/v1/chapters/1T07H2V5GwrpPNAH6032ES",
  };
}
