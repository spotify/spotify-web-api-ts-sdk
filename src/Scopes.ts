export class Scopes {
  public static get playlist() {
    return [...Scopes.playlistRead, ...Scopes.playlistModify];
  }
  ...
  public static get userLibrary() {
    return [...Scopes.userLibraryRead, ...Scopes.userLibraryModify];
  }
  ...
  public static get userRecents() {
    return ["user-top-read", "user-read-recently-played"];
  }

  public static get userFollow() {
    return [...Scopes.userFollowRead, ...Scopes.userFollowModify];
  }
  ...
  public static get userPlayback() {
    return [...Scopes.userPlaybackRead, ...Scopes.userPlaybackModify];
  }
  ...
  public static get userPlaybackModify() {
    return ["user-modify-playback-state", "app-remote-control", "streaming"];
  }
